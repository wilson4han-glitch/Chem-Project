...
sections = [
    ...
    ("    (Use the particle legend in the bottom-left corner of the simulation to identify each particle type.)", "normal"),
    ("", "normal"),
    ...
    ("", "normal"),
    ("Pair A:  Anode = Ni  |  Cathode = Cu", "bold_normal"),
    ("    Predicted E°cell: ___________V          Simulated voltage: ___________V", "normal"),
    ("", "normal"),
    ("Pair B:  Anode = Fe  |  Cathode = Ag", "bold_normal"),
    ("    Predicted E°cell: ___________V          Simulated voltage: ___________V", "normal"),
    ("", "normal"),
    ("7.  Which pair produces more voltage? Show the E°cell calculation for each, then explain why a larger difference in reduction potentials gives more voltage.", "normal"),
    ("", "normal"),
    ("    _________________________________________________________________", "normal"),
    ("    _________________________________________________________________", "normal"),
    ("", "normal"),
    ...
    ("    _________________________________________________________________", "normal"),
    ("", "normal"),
    ("12.  Reset concentrations to 1.00 M each. Raise temperature to 60°C using the Temperature slider.", "normal"),
    ("    a.  Does cell voltage increase, decrease, or stay the same?   ___________", "normal"),
    ("    b.  At Q = 1, the Nernst equation predicts E = E° regardless of temperature.", "normal"),
    ("        Set [Zn²⁺] = 2.00 M (Q > 1) and compare voltage at 25°C vs. 60°C.", "normal"),
    ("        Which temperature gives the lower voltage, and why?", "normal"),
    ("", "normal"),
    ("        _________________________________________________________________", "normal"),
    ("        _________________________________________________________________", "normal"),
    ("", "normal"),
    ...
    ("", "normal"),
    ("13.  Before pressing Play: predict what will happen to cell voltage over time as the reaction proceeds.", "normal"),
    ("", "normal"),
    ("    _________________________________________________________________", "normal"),
    ("", "normal"),
    ("Now press Play and watch until the EQUILIBRIUM REACHED overlay appears.", "bold_normal"),
    ("", "normal"),
    ("14.  Describe what happened to the voltmeter reading as the cell ran:", "normal"),
    ("", "normal"),
    ("    _________________________________________________________________", "normal"),
    ("", "normal"),
    ("15.  At the moment equilibrium is reached:", "normal"),
    ("    a.  What is E?   ___________     b.  What is ΔG?   ___________     c.  How does Q compare to K?   ___________", "normal"),
    ("", "normal"),
    ("16.  Why does the simulation label this state \"EQUILIBRIUM REACHED\" rather than just \"battery dead\"?", "normal"),
    ...
    ("", "normal"),
    ("17.  Look at the ΔG panel between the beakers.", "normal"),
    ("    a.  What minimum voltage is required to drive the reaction? (read from the simulation)   ___________", "normal"),
    ("    b.  What is the sign of ΔG shown in the panel?   ___________", "normal"),
    ("        What does a positive ΔG confirm about whether this reaction is spontaneous?", "normal"),
    ("", "normal"),
    ("        _________________________________________________________________", "normal"),
    ("", "normal"),
    ("18.  Compare the minimum required voltage to E°cell from Section 1 (Zn | Cu galvanic cell). What relationship do you notice?", "normal"),
    ("", "normal"),
    ("    _________________________________________________________________", "normal"),
    ("", "normal"),
    ("19.  What is deposited onto the cathode? Why does plating occur at the cathode and not the anode?", "normal"),
    ("", "normal"),
    ("    _________________________________________________________________", "normal"),
    ("", "normal"),
    ("Now set cathode [Zn²⁺] to 0.10 M, set speed to maximum, and run until the SOLUTION EXHAUSTED overlay appears.", "bold_normal"),
    ("", "normal"),
    ("20.  a.  What total mass was deposited?   ___________g", "normal"),
    ...
    ("", "normal"),
    ("21.  For copper plating (M = 63.55 g/mol, n = 2), calculate the mass deposited in 120 seconds at 4.0 A. Show full work.", "normal"),
    ("", "normal"),
    ("    ___________________________________________________________________", "normal"),
    ("    ___________________________________________________________________", "normal"),
    ("", "normal"),
    ...
    ("", "normal"),
    ("22.  Change the current to 8.0 A. Predict and verify the mass deposited in the same 120 seconds:", "normal"),
    ("", "normal"),
    ("    Predicted mass: ___________g          Simulated mass: ___________g", "normal"),
    ("", "normal"),
    ("23.  You need to deposit exactly 1.00 g of silver  (M = 107.87 g/mol, n = 1)  at a current of 3.0 A.", "normal"),
    ...
    ("", "normal"),
    ("24.  A galvanic cell has E°cell = +0.46 V at standard conditions, but the voltmeter reads +0.38 V during operation.", "normal"),
    ...
    ("        _________________________________________________________________", "normal"),
    ("", "normal"),
    ("25.  A student electroplates iron with gold  (Au³⁺/Au, E° = +1.50 V)  using an iron anode  (Fe²⁺/Fe, E° = −0.44 V).", "normal"),
